...
public class AccountController extends HttpServlet {
    ...
    private void login(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        com.atbm.models.Account account = accountService.login(username, password);
        if (account != null) {
            ...
            resp.sendRedirect("/ATBM_war_exploded/product?action=shop");
        } else {
    ...
    private void forgotPassword(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        com.atbm.models.Account account = accountService.getAccountByEmail(email);
