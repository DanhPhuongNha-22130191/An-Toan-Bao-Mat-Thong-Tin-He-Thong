...
INSERT INTO Account (username, password, email) VALUES
                                                    (N'john_doe', N'hashed_password_1', N'john.doe@example.com'),
                                                    (N'jane_smith', N'hashed_password_2', N'jane.smith@example.com'),
                                                    (N'robert_johnson', N'hashed_password_3', N'robert.johnson@example.com'),
                                                    (N'susan_wilson', N'hashed_password_4', N'susan.wilson@example.com'),
                                                    (N'mike_brown', N'hashed_password_5', N'mike.brown@example.com');

-- Product Specifications (assuming productId starts from 1 to 7)
...
-- WatchType (assuming productId starts from 1 to 7)
...
INSERT INTO OrderDetail (orderId, productId, quantity, fullName, phone, email, address, orderNote) VALUES
                                                                                                       ...
                                                                                                       (1, 3, 2, N'John Doe', N'+1-555-123-4567', N'john.doe@example.com', N'123 Main St, New York, NY 10001', NULL),
                                                                                                       (2, 2, 1, N'Jane Smith', N'+1-555-987-6543', N'jane.smith@example.com', N'456 Oak Ave, Los Angeles, CA 90001', NULL),
                                                                                                       (3, 4, 1, N'Robert Johnson', N'+1-555-246-8135', N'robert.johnson@example.com', N'789 Pine Rd, Chicago, IL 60007', N'Call before delivery'),
                                                                                                       (4, 7, 1, N'John Doe', N'+1-555-123-4567', N'john.doe@example.com', N'123 Main St, New York, NY 10001', NULL),
                                                                                                       (5, 6, 3, N'Susan Wilson', N'+1-555-369-8521', N'susan.wilson@example.com', N'321 Cedar Ln, Miami, FL 33101', N'Leave with the doorman');