						...
						<ul class="nav navbar-nav menu_nav ml-auto mr-auto">
							...
							<li class="nav-item active submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link" href="cart.jsp">Shopping
											Cart</a></li>
								</ul></li>
									...
									<td>
										<div class="product_count">
											<input type="text" name="qty" id="sst-${cart.productId}"
												maxlength="12" value="${cart.quantity}"
								...
								<td>
									<div class="cupon_text d-flex align-items-center">
										<input type="text" placeholder="Coupon Code"> <a
											class="primary-btn" href="#">Apply</a> <a class="button"
											href="#">Have a Coupon?</a>
									</div>
								</td>
							</tr>
							<tr>
