  ...
  <!--================ Start Header Menu Area =================-->
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="${pageContext.request.contextPath}/views/index.jsp"><img src="${pageContext.request.contextPath}/assests/img/logo.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/views/index.jsp">Home</a></li>
              ...
              <li class="nav-item active submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/views/blog.jsp">Blog Single</a></li>
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
            <div class="categories_post">
                <img class="card-img rounded-0" src="${pageContext.request.contextPath}/assests/img/blog/cat-post/cat-post-3.jpg" alt="post">
        ...
        <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
          <div class="categories_post">
            <img class="card-img rounded-0" src="${pageContext.request.contextPath}/assests/img/blog/cat-post/cat-post-2.jpg" alt="post">
            <div class="categories_details">
              <div class="categories_text">
                <a href="single-blog.html">
                    <h5>Politics</h5>
        ...
        <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
            <div class="categories_post">
                <img class="card-img rounded-0" src="${pageContext.request.contextPath}/assests/img/blog/cat-post/cat-post-1.jpg" alt="post">
                <div class="categories_details">
                    <div class="categories_text">
                        <a href="single-blog.html">
                            <h5>Food</h5>
              ...
              <div class="col-lg-8">
                  <div class="blog_left_sidebar">
                      <article class="row blog_item">
                          ...
                          <div class="col-md-9">
                              <div class="blog_post">
                                  <img src="${pageContext.request.contextPath}/assests/img/blog/main-blog/m-blog-1.jpg" alt="">
                      ...
                      <article class="row blog_item">
                          ...
                          <div class="col-md-9">
                              <div class="blog_post">
                                  <img src="${pageContext.request.contextPath}/assests/img/blog/main-blog/m-blog-2.jpg" alt="">
                                  <div class="blog_details">
                                      <a href="single-blog.html">
                      ...
                      <article class="row blog_item">
                          ...
                          <div class="col-md-9">
                              <div class="blog_post">
                                  <img src="${pageContext.request.contextPath}/assests/img/blog/main-blog/m-blog-3.jpg" alt="">
                                  <div class="blog_details">
                                      <a href="single-blog.html">
                      ...
                      <article class="row blog_item">
                          ...
                          <div class="col-md-9">
                              <div class="blog_post">
                                  <img src="${pageContext.request.contextPath}/assests/img/blog/main-blog/m-blog-4.jpg" alt="">
                                  <div class="blog_details">
                                      <a href="single-blog.html">
                                          <h2>The Night Sky</h2>
                                      </a>
                      ...
                      <article class="row blog_item">
                          ...
                          <div class="col-md-9">
                              <div class="blog_post">
                                  <img src="${pageContext.request.contextPath}/assests/img/blog/main-blog/m-blog-5.jpg" alt="">
                                  <div class="blog_details">
                                      <a href="single-blog.html">
              ...
              <div class="col-lg-4">
                  <div class="blog_right_sidebar">
                      ...
                      <aside class="single_sidebar_widget author_widget">
                          <img class="author_img rounded-circle" src="${pageContext.request.contextPath}/assests/img/blog/author.png"" alt="">
                      ...
                      <aside class="single_sidebar_widget popular_post_widget">
                          ...
                          <div class="media post_item">
                              <img src="${pageContext.request.contextPath}/assests/img/blog/popular-post/post1.jpg" alt="post">
                          ...
                          <div class="media post_item">
                              <img src="${pageContext.request.contextPath}/assests/img/blog/popular-post/post2.jpg" alt="post">
                              <div class="media-body">
                                  <a href="single-blog.html">
                          ...
                          <div class="media post_item">
                              <img src="${pageContext.request.contextPath}/assests/img/blog/popular-post/post3.jpg" alt="post">
                              <div class="media-body">
                                  <a href="single-blog.html">
                          ...
                          <div class="media post_item">
                              <img src="${pageContext.request.contextPath}/assests/img/blog/popular-post/post4.jpg" alt="post">
                              <div class="media-body">
                                  <a href="single-blog.html">
                      ...
                      <aside class="single_sidebar_widget ads_widget">
                          <a href="#">
                              <img class="img-fluid" src="${pageContext.request.contextPath}/assests/img/blog/add.jpg" alt="">
                          </a>
                          <div class="br"></div>
                      </aside>
  ...
  <section class="instagram_area">
    <div class="container box_1620">
      ...
      <div class="instagram_image row m0">
        <a href="#"><img src="${pageContext.request.contextPath}/assests/img/instagram/ins-1.jpg" alt=""></a>
        <a href="#"><img src="${pageContext.request.contextPath}/assests/img/instagram/ins-2.jpg" alt=""></a>
        <a href="#"><img src="${pageContext.request.contextPath}/assests/img/instagram/ins-3.jpg" alt=""></a>
        <a href="#"><img src="${pageContext.request.contextPath}/assests/img/instagram/ins-4.jpg" alt=""></a>
        <a href="#"><img src="${pageContext.request.contextPath}/assests/img/instagram/ins-5.jpg" alt=""></a>
        <a href="#"><img src="${pageContext.request.contextPath}/assests/img/instagram/ins-6.jpg" alt=""></a>
      </div>
    </div>
  </section>
  <!--================End Instagram Area =================-->
