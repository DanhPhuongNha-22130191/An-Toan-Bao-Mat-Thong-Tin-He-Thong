            ...
            <div class="row s_product_inner">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <h2>$${product.price}</h2>
                        <ul class="list">
                            <li><a class="active" href="#"><span>Category</span> : ${product.categoryId}</a></li>
                            ...
                            <form action="ProductController" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button type="button" style="top:8px;" class="reduced items-count" onclick="decreaseQuantity()">
                                            <i class="ti-angle-left"></i>
                                        </button>
                                        <input type="text" name="qty" id="sst" size="2" maxlength="12" value="1" title="Quantity:" class="input-text qty">
                                        <button type="button" style="top:8px;" class="increase items-count" onclick="increaseQuantity()">
